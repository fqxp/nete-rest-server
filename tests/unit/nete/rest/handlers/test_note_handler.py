...
from nete.rest.handlers.note_handler import NoteHandler
...
class TestNoteHandler(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.handler = NoteHandler(app_mock, self.request_mock, connection=connection)
    ...
    def test_get_reads_document_from_database(self):
        ...
        self.connection.Note = mock.MagicMock()
        note = Mock.Mock()
        self.connection.Note.fetch_one = mock.Mock(return_value = note)
